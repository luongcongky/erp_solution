...
async function seedTranslations() {
    try {
        console.log('[Seed] Upserting UI translations for core module...\n');

        const ten_id = '1000';
        const stg_id = 'DEV';

        // Translation data with all keys for Users, Roles, Audit-Logs, Menus pages
        const translations = [
            // Common translations
            {
                key: 'common.allRoles',
            ...
            // Auth/Login page
            {
                key: 'pages.auth.title',
                module: 'core',
                description: 'Login page title',
                translations: {
                    vi: 'Đăng nhập hệ thống',
                    en: 'Login to System',
                    ko: '시스템 로그인'
                }
            },
            {
                key: 'pages.auth.subtitle',
                module: 'core',
                description: 'ERP subtitle',
                translations: {
            ...
            {
                key: 'pages.auth.emailPlaceholder',
                module: 'core',
            ...
            {
                key: 'pages.auth.passwordPlaceholder',
                module: 'core',
            ...
            {
                key: 'pages.auth.loggingIn',
                module: 'core',
                description: 'Logging in loading state',
                translations: {
                    vi: 'Đang đăng nhập...',
                    en: 'Logging in...',
                    ko: '로그인 중...'
            ...
            {
                key: 'pages.auth.demoAccount',
                module: 'core',
                description: 'Demo account title',
                translations: {
                    vi: 'Tài khoản demo:',
                    en: 'Demo Account:',
                    ko: '데모 계정:'
            ...
            {
                key: 'pages.auth.demoEmail',
                module: 'core',
                description: 'Demo email label',
                translations: {
                    vi: 'Email: admin@gmail.com',
                    en: 'Email: admin@gmail.com',
                    ko: '이메일: admin@gmail.com'
                }
            },
            {
                key: 'pages.auth.demoPassword',
                module: 'core',
                description: 'Demo password label',
                translations: {
        ...
        // Insert or update translations using upsert
        let totalInserted = 0;
        let totalUpdated = 0;
